...
const userController = {
    ...
    acceptFriends: async (req,res)=>{
        var userSender = req.body.userSender;
        var userReceiver = req.body.userReceiver;
        var nameSend =req.body.nameSend;
        var nameRecei = req.body.nameRecei;
        res.status(200).json(await userService.acceptFriends(userSender,userReceiver,nameSend,nameRecei));
    },
